<div class="container-fluid">
	...
	<p class="lead">Agregar un nuevo ADMINISTRADOR al Sistema</p>
</div>
		    	...
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
		    					<?php
		    						if($_SESSION['privilegio_sesion'] ==1):
		    					?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $loginControl->encriptar(1); ?>">
												<i class="zmdi zmdi-star"></i> &nbsp; Nivel 1
											</label>
										</div>
								<?php
									endif;
									if($_SESSION['privilegio_sesion'] <=2):
								?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios2" value="<?php echo $loginControl->encriptar(2); ?>">
								...
								?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="<?php echo $loginControl->encriptar(3); ?>" checked="">
